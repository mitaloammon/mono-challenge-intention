...
exports.IntentionController = void 0;
var common_1 = require("@nestjs/common");
var IntentionController = exports.IntentionController = function () {
    var _classDecorators = [(0, common_1.Controller)('intention')];
    ...
    var IntentionController = _classThis = /** @class */ (function () {
        function IntentionController_1(intentionService) {
            this.intentionService = (__runInitializers(this, _instanceExtraInitializers), intentionService);
        }
        IntentionController_1.prototype.create = function (createIntentionDto) {
            return this.intentionService.create(createIntentionDto);
        };
        IntentionController_1.prototype.findAll = function () {
            return this.intentionService.findAll();
        };
        IntentionController_1.prototype.findOne = function (id) {
            return this.intentionService.findOne(+id);
        };
        IntentionController_1.prototype.update = function (id, updateIntentionDto) {
            return this.intentionService.update(+id, updateIntentionDto);
        };
        return IntentionController_1;
    }());
    __setFunctionName(_classThis, "IntentionController");
    (function () {
        ...
        IntentionController = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return IntentionController = _classThis;
}();
